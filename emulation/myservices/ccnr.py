...
class CCNRService(CoreService):
    ...
    _configs = ('ccnrservice_start.sh', 'ccnrservice_stop.sh')
    # this controls the starting order vs other enabled services
    _startindex = 60
    # list of startup commands, also may be generated during startup
    _startup = ('/bin/bash ccnrservice_start.sh',)
    # list of shutdown commands
    _shutdown = ('/bin/bash ccnrservice_stop.sh',)
    ...
    def generateconfig(cls, node, filename, services):
        ...
        cfg =  "#!/bin/bash\n"
        cfg += "# auto-generated by CCNRService (ccnr.py)\n"
...
start() {
    touch /tmp/ccnr.log
	$CCNX_DIR/bin/ccnr > /tmp/ccnr.log 2>&1 &
}
